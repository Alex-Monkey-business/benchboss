...
const links = [
  ...
  { to: '/cup', label: 'Cup-kamper', icon: 'cup' }
]
    ...
    <div class="px-lg admin-list">
      ...
      >
        <span class="admin-row__icon">
          ...
          <svg v-else-if="link.icon === 'cup'" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round">
