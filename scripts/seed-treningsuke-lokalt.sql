-- Fikstur for scripts/treningsuke-test.mjs: treningsuka til Halsen G2015 med
-- tre dager og 3/2/4 øvelser. Lørdagen med fire er caset som utløste
-- omleggingen — den var 1140 px høy på en 390-skjerm.
--
-- Uka har ingen måned å ligge i (se 20260903090000_uka_er_kanon.sql): dagene
-- henger rett på kullet.
--
...
insert into training_sessions (title,weekday,position,accent,duration_min,focus,drills,cohort_id) values
('Tirsdag',2,0,'sky',90,'Ferdigheter under press. Bli sjef over ballen i trange rom — medtak, vending og første touch som tar deg ut av presset.',
...
('Torsdag',4,1,'peach',90,'Grunnferdigheter og spill. Ferdighetssirkel for å bli sjef over ballen, så smålagsspill 3v3 med mye involvering.',
